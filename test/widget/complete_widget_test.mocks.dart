...
// in meditrack/test/widget/complete_widget_test.dart.
...
import 'package:meditrack/core/network/connectivity_provider.dart' as _i7;
...
class MockAuthProvider extends _i1.Mock implements _i2.AuthProvider {
  ...
  @override
  void loadUser() => super.noSuchMethod(
    Invocation.method(#loadUser, []),
    returnValueForMissingStub: null,
  );

  @override
  _i3.Future<void> loadProfileImage() =>
      (super.noSuchMethod(
            Invocation.method(#loadProfileImage, []),
  ...
  @override
  _i3.Future<void> setProfileImage({String? path, _i5.Uint8List? bytes}) =>
      (super.noSuchMethod(
            Invocation.method(#setProfileImage, [], {
              #path: path,
              #bytes: bytes,
            }),
            returnValue: _i3.Future<void>.value(),
